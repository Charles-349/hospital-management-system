...
//         {/* <CreatePayment refetch={refetch} appointment={null} onPaymentCreated={handlePaymentCreated} /> */}
...
const Payments = () => {
  ...
  // ✅ Required for CreatePayment
  const handlePaymentCreated = (
    paymentID: number,
    amount: number,
    phoneNumber: string
  ) => {
    console.log("New payment created:", { paymentID, amount, phoneNumber });
    toast.success(`Payment #${paymentID} created for ${phoneNumber}`);
    // optionally trigger Mpesa modal or follow-up actions
  };
