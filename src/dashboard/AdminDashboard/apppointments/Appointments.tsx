          ...
          <table className="table table-xs">
            ...
            <tbody>
              <tr className="hover:bg-gray-300 border-b border-gray-400">
                <td>{searchResult.appointmentID}</td>
                <td>{searchResult.userID}</td>
                <td>{searchResult.doctorID}</td>
                <td>{searchResult.appointmentDate}</td>
                <td>{searchResult.timeSlot}</td>
                <td>{searchResult.totalAmount}</td>
                <td>{renderStatusBadge(searchResult.appointmentStatus)}</td>
                <td className="flex">
                  <button
            ...
            <tbody>
              {searchUserResults.map((appointment) => (
                <tr key={appointment.appointmentID} className="hover:bg-gray-300 border-b border-gray-400">
                  ...
                  <td>{renderStatusBadge(appointment.appointmentStatus)}</td>
                  <td className="flex">
                    <button
                      className="btn btn-sm btn-primary mr-4 text-blue-500"
