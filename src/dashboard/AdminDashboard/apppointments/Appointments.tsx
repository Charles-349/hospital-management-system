...
//   const [mpesaAppointment, setMpesaAppointment] = useState<TAppointment | null>(null); 
...
//   const handleInitiateMpesa = (appointment: TAppointment) => {
//     setMpesaAppointment(appointment);
...
//       <InitiateMpesaPayment refetch={refetch} appointment={mpesaAppointment} /> 
...
//       {/* RENDER TABLES: single, user results, or all */}
//       {(searchResult ? [searchResult] : searchUserResults || appointmentsData?.appointments || []).length > 0 ? (
...
//             </thead>
//             <tbody>
//               {(searchResult ? [searchResult] : searchUserResults || appointmentsData?.appointments || []).map(
//                 (appointment) => (
...
//                       </button>
//                       <button
//                         className="btn bg-gray-700 text-white border border-gray-400 px-2 py-1"
//                         onClick={() => handleMakePayment(appointment)}
//                       >
//                         Record Payment
//                       </button>
//                       <button
//                         className="btn bg-green-700 text-white border border-green-800 px-2 py-1"
//                         onClick={() => handleInitiateMpesa(appointment)}
//                       >
//                         Pay with M-PESA
//                       </button>
//                     </td>
...
//           {!appointmentsLoading && !appointmentsData?.appointments?.length && <p>No Appointments Found.</p>}
//         </>
//       )}
//     </div>
//   );
