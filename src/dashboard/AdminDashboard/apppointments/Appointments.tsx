            ...
            <tbody>
              <tr className="hover:bg-gray-300 border-b border-gray-400">
                ...
                <td className="flex">
                  ...
                  <button
                    className="btn btn-xs bg-gray-600 text-white hover:bg-gray-700 border border-gray-400 rounded-lg px-4 py-2"
              ...
              {searchUserResults.map((appointment) => (
                <tr key={appointment.appointmentID} className="hover:bg-gray-300 border-b border-gray-400">
                  ...
                  <td className="flex">
                    ...
                    <button
                      className="btn btn-xs bg-gray-600 text-white hover:bg-gray-700 border border-gray-400 rounded-lg px-4 py-2 text-lg"
                  ...
                  {appointmentsData.appointments.map((appointment) => (
                    <tr key={appointment.appointmentID} className="hover:bg-gray-300 border-b border-gray-400">
                      ...
                      <td className="flex">
                        ...
                        <button
                          className="btn btn-xs bg-gray-600 text-white hover:bg-gray-700 border border-gray-400 rounded-lg px-4 py-2 text-lg ml-2"
                          onClick={() => handleMakePayment(appointment)}
                        >
                          Make Payment
                        </button>
